...
# Initialise Stiffness- and convection cumdumpsters:
...
C[np.ix_(loc_glob[0], loc_glob[0])] += cf.assemble_convection_matrix(vec1,
                                                                np.dot(X1,D),
                                                                np.dot(X1.T,D),
                                                                np.dot(Y1, D),
                                                                np.dot(Y1.T, D),
                                                                ...
                                                                N,
                                                                weights)
C[np.ix_(loc_glob[1], loc_glob[1])] += cf.assemble_convection_matrix(vec2,
                                                                np.dot(X2,D),
                                                                np.dot(X2.T,D),
                                                                np.dot(Y2, D),
                                                                np.dot(Y2.T, D),
                                                                ...
                                                                N,
                                                                weights)
C[np.ix_(loc_glob[2], loc_glob[2])] += cf.assemble_convection_matrix(vec3,
                                                                np.dot(X3,D),
                                                                np.dot(X3.T,D),
                                                                np.dot(Y3, D),
                                                                np.dot(Y3.T, D),
                                                                ...
                                                                N,
                                                                weights)
C[np.ix_(loc_glob[3], loc_glob[3])] += cf.assemble_convection_matrix(vec4,
                                                                np.dot(X4,D),
                                                                np.dot(X4.T,D),
                                                                np.dot(Y4, D),
                                                                np.dot(Y4.T, D),
                                                                ...
                                                                N,
                                                                weights)
C[np.ix_(loc_glob[4], loc_glob[4])] += cf.assemble_convection_matrix(vec5,
                                                                np.dot(X5,D),
                                                                np.dot(X5.T,D),
                                                                np.dot(Y5, D),
                                                                np.dot(Y5.T, D),
                                                                ...
                                                                N,
                                                                weights)
C[np.ix_(loc_glob[5], loc_glob[5])] += cf.assemble_convection_matrix(vec6,
                                                                np.dot(X6,D),
                                                                np.dot(X6.T,D),
                                                                np.dot(Y6, D),
                                                                np.dot(Y6.T, D),
